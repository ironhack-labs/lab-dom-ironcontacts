...
;
  ...
  // Your code goes here ...
  const newRow = document.createElement("tr");
  const deleteButton = newRow.querySelectorAll(".btn-delete");
  tableBody.appendChild(newRow);
 ...
 const likeButton = newRow.querySelectorAll(".btn-like");
